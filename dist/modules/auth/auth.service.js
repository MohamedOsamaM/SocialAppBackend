...
class AuthService {
    ...
    sendForgotCode = async (req, res) => {
        ...
        if (!user) {
            throw new error_response_1.NotFoundException("invalid account due to one of the following reasons [not registerd , invalid provider , not confirmed]");
        }
        const otp = (0, otp_1.generateNumberOtp)();
    ...
    verifyForgotPassword = async (req, res) => {
        ...
        if (!user) {
            throw new error_response_1.NotFoundException("invalid account due to one of the following reasons [not registerd , invalid provider , not confirmed , missing password otp]");
        }
