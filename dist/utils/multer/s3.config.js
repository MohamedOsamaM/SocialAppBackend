...
exports.deleteFolderByPrefix = exports.listDirectoryFiles = exports.deleteFiles = exports.deleteFile = exports.createPreSignedGetLink = exports.getFile = exports.createPreSignedUploadLink = exports.uploadLargeFile = exports.uploadLargeFiles = exports.uploadFiles = exports.uploadFile = exports.s3Config = void 0;
...
const createPreSignedGetLink = async ({ Bucket = process.env.AWS_BUCKET_NAME, Key = "general", expiresIn = Number(process.env.AWS_PRE_SIGNED_URL_EXPIRES_IN_SECONDS), download = false, }) => {
    const command = new client_s3_1.GetObjectCommand({
        Bucket,
        Key,
...
exports.createPreSignedGetLink = createPreSignedGetLink;
